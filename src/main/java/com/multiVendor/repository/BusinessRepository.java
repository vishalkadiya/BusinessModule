...
public interface BusinessRepository extends JpaRepository<Business, Integer>{
	...
	@Query(value = "SELECT * FROM business_details b WHERE b.organisation_size >= :minimum and b.organisation_size <= :maximum", 
			  nativeQuery = true)
	List<Business> findOrganisationByGreaterThanEqualANDLessThanEqual(@Param("minimum") Integer minimum, @Param("maximum") Integer maximum);
