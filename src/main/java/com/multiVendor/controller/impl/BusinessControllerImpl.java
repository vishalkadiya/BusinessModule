...
public class BusinessControllerImpl implements BusinessController {
	...
	public ResponseEntity<Object> save(@RequestBody BusinessView businessView) throws Exception {
		...
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.SAVE + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " saveCompany");
		}
	}
	...
	public ResponseEntity<Object> search(@RequestParam("companyName") String companyName) throws Exception {
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.SEARCH_TABLE + " "
	...
	public ResponseEntity<Object> filterCity(@RequestParam("cityValue") String cityValue) throws Exception {
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.FILTER + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " filterCity");
		}
	}
	...
	public ResponseEntity<Object> filterState(@RequestParam("stateValue") String stateValue) throws Exception {
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.FILTER + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " filterState");
		}
	}
	...
	public ResponseEntity<Object> filterTypeOfFirm(@RequestParam("typeOfFirm") String typeOfFirm) throws Exception {
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.FILTER + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " filterTypeOfFirm");
		}
	}
	...
	public ResponseEntity<Object> filterIndusty(@RequestParam("industry") String industry) throws Exception {
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.FILTER + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " filterIndustry");
		}
	}

	@Override
	public ResponseEntity<Object> filterOrganisationSize(@RequestParam("min") Integer min,
		...
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.FILTER + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " filterOrganisation-Size");
		}
	}
	...
	public ResponseEntity<Object> filterAtoZ() throws Exception {
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.FILTER + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " A-to-Z");
		}
	}
	...
	public ResponseEntity<Object> filterZtoA() throws Exception {
		try {
			...
			log.info(this.getClass().getSimpleName() + " " + OperationName.FILTER + " "
					+ com.multiVendor.commonUtils.LogMessage.REQUEST_COMPLETED + " Z-to-A");
		}
	}
